...
def send_message(from_number, text_message):
  ...
  payload = {'MessageSid': thirtyfour, 'SmsSid': thirtyfour, 'AccountSid': 'ACec58767d0255847dccc2c2834851802a', 'From': from_number, 'To': '+17472335925', 'Body': text_message, 'NumMedia': '0'}
